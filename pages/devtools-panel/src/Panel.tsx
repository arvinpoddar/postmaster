    ...
    <div className="flex h-screen w-full flex-col items-center overflow-hidden">
      <div className="flex w-full items-center gap-3 border-b border-zinc-300 bg-zinc-100 p-1 dark:border-zinc-600 dark:bg-zinc-800">
        ...
        <div className="flex gap-1">
          ...
          <button className={buttonClass} title={'Clear log'} onClick={() => handleFilterToggle(!showFilters)}>
      ...
      {showFilters && (
        <div className="flex w-full flex-col gap-1 border-b border-zinc-300 bg-zinc-100 px-1 py-[6px] dark:border-zinc-600 dark:bg-zinc-800">
          <div className="flex gap-1">
            <RegexFilter
              value={originFilter}
